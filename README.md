![image](https://github.com/user-attachments/assets/37c60ebf-5123-42e2-840e-bf35ed464315)![logo ieee (1)](https://github.com/user-attachments/assets/0db4717d-fe13-4add-aeff-d8ab96f267b7)
...
| **Session 6:** Linear Regression| `regression`,`Linear regression`, `Loss function`, `Cost function`, `Mean Absolute Error (MAE)`, `Mean Squared Error (MSE)`, `residuals`, `Normal equation`, `Gradient descent`, `Stochastic Gradient Descent`, `mini-batch Gradient Descent`| 🔜 |🔜 | 🔜 |
| **Session 7:** Logistic Regression  polynomial regression| `Classification`, `logistic function`, `sigmoid functions`, `Odds`, `logits`, `log loss`, `Cross entropy`, `Newton method`, `polynomial regression` | 🔜 |🔜 | 🔜 |
