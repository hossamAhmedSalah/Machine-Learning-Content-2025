...
| **Session 9:** Ensembel| `Bootsrapping`, `Bagging`, `Boosting`, `Random Forest`, `Gradient Boosting`, `Ada Boosting`|[Slides](session_9_Ensemble_Learning/presentation/Ensemble_IEEE.pdf)| [Code](session_9_Ensemble_Learning/code/digit-classification-ensemble-techniques.ipynb)  [   ➕Extra code](session_9_Ensemble_Learning/extra_code/Ensemble_learning_IEEE.ipynb) |🔜 |
| **Session 10:** Unsupervised Learning| `K-means`, `Segmentation`, `PCA`, `ICA`, `Voice data`, `Anomaly detection`|🔜| 🔜 |🔜 |
