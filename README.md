...
| **Session 12:** Convolutional Neural Networks (CNN)| `Convolution layer`, `Pooling layer`, `Fully connected layer`, `Dialation`, `LeNET`, `AlexNET`, `VGG16`, `VGG19`, `Pretraind-models`, `fine-tuning`, `Data Augmentation`|[Slides](session_12_Convolution_Neural_Networks/presenetation)| [Code](session_12_Convolution_Neural_Networks/code/cnn.ipynb) | 🚫No task |
